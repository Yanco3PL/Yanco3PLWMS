...
export default function App() {
  ...
  if (loading) return <div className="app"><p style={{ color: "#626E8C" }}>Cargando WMS…</p></div>;
    ...
    <div className="app">
      ...
      <div className="summary-row">
        <div className="card">
          ...
          <div className="card-big">{unidadesTotal} <span style={{ fontSize: 14, color: "#8791AD" }}>/ {capacidadTotal}</span></div>
              ...
              {bines.map((b) => {
                ...
                return (
                  <tr key={b.id}>
                    ...
                    <td style={{ textAlign: "right", fontFamily: "'IBM Plex Mono', monospace", fontWeight: 500, color: sobre ? "#D6473C" : "#14213D" }}>{pct.toFixed(0)}%</td>
              ...
              {recepciones.map((r) => {
                ...
                return (
                  <tr key={r.id}>
                    ...
                    <td style={{ textAlign: "right" }}><input className="input" type="number" defaultValue={r.recibido} style={discre ? { borderColor: "#E08A1E", color: "#E08A1E" } : {}} onBlur={(e) => Number(e.target.value) !== Number(r.recibido) && updateRecepcion(r, { recibido: e.target.value })} /></td>
                    <td>
                    ...
                    <td style={{ textAlign: "right", fontFamily: "'IBM Plex Mono', monospace", fontWeight: 500, color: enRiesgo ? "#D6473C" : "#14213D" }}>{h.toFixed(1)}h</td>
              ...
              {ordenes.map((o) => {
                ...
                return (
                  <tr key={o.id}>
                    ...
                    <td>
                      <select className="select" value={o.prioridad} onChange={(e) => updateOrden(o, { prioridad: e.target.value })} style={o.prioridad === "Urgente" ? { color: "#E08A1E", fontWeight: 600 } : {}}>
